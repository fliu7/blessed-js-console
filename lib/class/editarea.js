...
var nextTick = global.setImmediate || process.nextTick.bind(process),
    unicode  = require('neo-blessed/lib/unicode'),
    helpers  = require('neo-blessed/lib/helpers'),
    Input    = require('neo-blessed/lib/widgets/input'),
    Node     = require('neo-blessed/lib/widgets/node');
