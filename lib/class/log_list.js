module.exports = function defineLogList(Janeway, Blast) {
	 ...
	 */
	var LogList = Blast.Bound.Function.inherits('Informer', 'Develry.Janeway', function LogList(janeway, screen, box) {
	 ...
	 * @version  0.1.4
	 */
	LogList.setMethod('render', throttle(function render() {
		this.box.render();
		this.screen.render();
	}, 70));
