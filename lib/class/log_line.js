const { toPaddedString } = require('../helpers');

module.exports = function defineLogLine(Janeway, Blast) {
	 ...
	 */
	var LogLine = Blast.Bound.Function.inherits('Informer', 'Develry.Janeway', function LogLine(logList) {
	...
	LogLine.setMethod(function getRelativeX(absX) {
		return absX - (this.strlen(this.gutter) || 0) - (this.strlen(this.fileinfo) || 0);
	});
